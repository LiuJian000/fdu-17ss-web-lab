...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              <?php
              include 'travel-data.inc.php';
              $countries = array(0 => "Canada", 1 =>"Germany", 2 => "Greece", 3 => "Italy", 4 => "United Kingdom", 5 => "United States",);
              for($i=0; $i<count($countries); $i++) {
                  echo '<a href = "list.php?country='.$countries[$i].'" role = "button" class = "btn btn-default">'.$countries[$i].'</a>';
              }
        ...
        <ul class="caption-style-2">
            ...
            print ' 
                 ...
                 <a href="detail.php?id='.$imageId.' " class="img-responsive">
                 	<img src="images/square/'.$imagePath.' " alt="'.$imageDescription.'">
                 	<div class="caption">
                 		<div class="blur">
                 		</div>
